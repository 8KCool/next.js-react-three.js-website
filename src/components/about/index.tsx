  ...
  return (
    <section className=" overflow-hidden bg-white py-10">
      <div className="container mx-auto flex flex-col  items-center justify-center px-4 text-center">
        <p className="  bg mb-4 mt-5 text-center text-2xl font-normal tracking-wide text-black lg:text-3xl  ">
          LEADERSHIP
        </p>
        <h2 className=" mt-5 mb-10  w-full  px-12 text-base leading-tight   lg:w-1/2 ">
      ...
      <div className="relative mx-auto max-w-7xl  px-16">
        <div className="sm:gr  id-cols-3 grid w-full grid-cols-2 gap-10 lg:grid-cols-4">
          {teams.map((team) => (
            <div
              key={team.name}
            ...
            >
              <div className=" flex flex-col p-5">
                <div className="   -mt-5 -ml-5 h-full w-full rounded-full  bg-blue-50"></div>
                <img
              ...
              <div className="mt-3 space-y-2 text-center">
                <div className="space-y-1 text-lg font-medium leading-6">
                  ...
                  <p className="box-border flex  text-center text-sm leading-6 text-gray-500 lg:text-left">
                    {' '}
                    {team.description}{' '}
                  </p>
                </div>
