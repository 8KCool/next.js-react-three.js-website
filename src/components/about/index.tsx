...
const AboutComponent = () => {
  return (
    <section className="py-10 overflow-hidden bg-white ">
      <div className="flex flex-col items-center justify-center px-4 mx-auto text-center global-container">
        <p className="mt-5 mb-4 text-2xl font-normal tracking-wide text-center text-black  bg lg:text-3xl">
          LEADERSHIP
        </p>
        <h2 className="w-full px-12 mt-5 mb-10 text-base leading-tight  lg:w-1/2">
