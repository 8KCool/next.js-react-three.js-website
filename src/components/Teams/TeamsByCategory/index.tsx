    ...
    <div className="flex w-full flex-col items-center">
      {category === 'all' ? (
        <>
          ...
          <div className="grid justify-between gap-4 pt-8 sm:grid-cols-2 md:flex md:px-2 lg:grid-cols-3 xl:grid-cols-4">
            {teams
          ...
          <div className="grid max-w-[1300px] gap-4 pt-8 sm:grid-cols-2 md:grid-cols-3  md:px-2 2xl:grid-cols-4">
            {teams
