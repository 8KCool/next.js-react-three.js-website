    ...
    >
      ...
      >
        <div>
          ...
          <br></br>          <br></br>
          <p className="abo_p">Trigan is an innovative startup that is transforming cities into smarter, safer, and more connected places.
          <br></br>
          We make geo-located places smarter by using cutting-edge blockchain technology and smart city operating systems to empower and enable real-world urban communities everywhere.
          </p>
          <img
            loading='lazy'
