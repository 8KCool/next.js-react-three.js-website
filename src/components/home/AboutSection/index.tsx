...
export const AboutSection: React.FC<AboutSectionProps> = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h2 className="abo_h2">We make geo-located places smarter</h2>
          <p className="abo_p">Our technology enables us to tackle big issues globally. We will empower and enable real-world urban communities everywhere while addressing poverty, inequality and deprivation, so that no-one is left behind.</p>
          <img
            loading='lazy'
