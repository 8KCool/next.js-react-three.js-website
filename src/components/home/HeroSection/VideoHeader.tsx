          ...
          setCurrentItem(
            ...
            <div className="flex flex-col align-center justify-end  w-full h-[500px] m-auto max-[500px]:w-[300px]">
              <div className="flex justify-center h-[150px]">
                ...
                >
                  <p className="mt-[25px] text-[25px] font-bold font-m_plus_rounded_1c dark:text-purple-500">
                    A Better Life
                  </p>
            ...
            <>
              <div className="flex flex-col align-center justify-end  w-full h-[500px] m-auto max-[500px]:w-[300px]">
                <div className="flex justify-center h-[150px]">
                  ...
                  >
                    <p className="mt-[25px] text-[25px] font-bold font-m_plus_rounded_1c dark:text-purple-500  max-[400px]:text-[22px]">
              ...
              <div className="flex flex-col  align-center justify-end  w-full h-[500px] m-auto max-[500px]:w-[300px]">
                <div className="flex justify-center h-[150px]">
                  <h1
                    ...
                    className={`text-center font-m_plus_rounded_1c font-semibold uppercase md:font-bold`}
                  >
                    <p className="mt-[30px] text-[22px] font-bold font-m_plus_rounded_1c dark:text-purple-500 max-[400px]:text-[18px]">
