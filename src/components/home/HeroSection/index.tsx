...
export const HeroSection: React.FC<HeroSectionProps> = () => {
  ...
  useEffect(() => {
    document.addEventListener('scroll', () => {
      ...
      if (section) {
        let opacity =
          (section.offsetHeight - document.documentElement.scrollTop) /
        ...
        case 1:
          setCurrentItem(
            <h1 className="text-center uppercase text-white">
              Explore <div className="text-7xl font-bold">Montana</div>
            </h1>
          )
          break
        case 2:
          setCurrentItem(
            <h1 className="text-center uppercase text-white">
              Explore <div className="text-7xl font-bold">Mexico</div>
            </h1>
          )
          break
      }
  ...
  return (
    <div
      id="hero_section"
      className="grid h-[70vh] items-center bg-primary bg-opacity-70 lg:h-[80vh] 2xl:h-screen "
    >
      <video
        className="absolute -z-10 h-[70vh] w-auto min-w-full object-cover lg:h-[80vh] 2xl:h-screen  "
        width="618"
        height="347"
        autoPlay
        loop
