    ...
    >
      <a href="">
        ...
        style={getBackgroundInfo(index)}
          ...
          } post group relative w-[48%] overflow-hidden bg-[rgba(84,84,84,0.6)] py-[50px] text-center text-5xl uppercase text-white transition-all  duration-[0.5s]
           before:absolute before:bottom-[54%]  before:h-[55%] before:origin-[100%,0] 
           before:bg-[#f2f2f2] before:pl-[3%]  before:content-[''] after:absolute after:top-[54%] after:h-[55%] after:origin-[100%,0] after:bg-[#f2f2f2] after:pl-[3%] after:content-[''] group-hover:!text-black`}
        >
          <i
      ...
      <div
        ...
        }  relative float-left w-2/4 text-center before:absolute before:top-[63px]  before:z-10 before:h-5 before:w-5 before:rounded-full before:border-4 
         before:border-solid before:border-[#7d7d7d] 
        before:bg-[#f2f2f2] before:shadow-[0_0_0_5px_rgba(250,250,250,0.9)] before:content-[''] after:absolute after:top-[73px] 
         after:-z-[1px] after:h-[3px] after:w-2/4 after:bg-[#BBFF33] after:content-['']`}
      >
        <div className={` subHeadStyle  ${rotate&&"mr-[79px]"} ${!rotate&&"ml-[79px]"} bg-transparent relative z-50 mt-[50px] inline-block border-2 border-solid
