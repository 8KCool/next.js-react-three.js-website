        ...
        <div className="relative w-screen">
            <div className="px-8 md:px-24 lg:px-32">
                <div className='grid justify-items-center'>
                    ...
                    <div className='mt-5'>
                        <p className='text-6xl font-medium text-white font-sans'>The Future of <span className='text-violet-600'>Social Impact</span></p>
                    </div>
                ...
                <div className='mt-32 mb-6'>
                    ...
                    <div className='mt-5'>
                        <p className='text-6xl font-medium text-white font-sans'>Increased <span className='text-violet-600'>Transparency and Trust</span></p>
                    </div>
                ...
                <div className='grid justify-items-center mt-16'>
                    <div className="mt-10 w-full">
                        <div className="py-6 px-28 bg-gradient-to-tl from-neutral-900 to-neutral-700 rounded-3xl shadow-md bg-white-800">
                            <div className='flex flex-row'>
                                <div className='w-full p-4 text-right'>
                                    <button className='btn bg-slate-100 bg-opacity-25 text-white rounded-full py-1 px-3 text-xs'>
                                        #Introduction
                                    </button>
                                    <h5 className="my-2 text-2xl font-medium tracking-tight text-white">Empowering</h5>
                                    <h5 className="mb-2 text-2xl font-medium tracking-tight text-violet-600">Communities and Individuals</h5>
                        ...
                        <div className="py-6 px-28 bg-gradient-to-tl from-neutral-900 to-neutral-700 rounded-3xl shadow-md bg-white-800">
                            <div className='flex flex-row'>
                                <div className='w-full p-4'>
                                    ...
                                    <h5 className="my-2 text-2xl font-medium tracking-tight text-white">From <span className='text-violet-600'>Poverty to Inequality</span></h5>
                                    <p className="mb-3 font-normal text-gray-500 text-gray-400 text-sm leading-relaxed">
                ...
                <div className='grid justify-items-center'>
                    <div className="mt-8 w-full">
                        <div className="py-12 px-28 bg-gradient-to-tl from-neutral-900 to-neutral-700 rounded-3xl shadow-md bg-white-800">
                            <div className='flex flex-row'>
