      ...
      <GlobalLayout>
        <section className="py-5 text-justify">
          <div className="text-center">
            <h2 className="text-xl font-semibold">trigan.org Privacy Policy</h2>
            <div className="py-4">
          ...
          <div className="mx-auto mt-5 max-w-4xl">
            {/* contact starts */}
            <p>
              trigan.org (the &quot;Site&ldquo;) is owned and operated by Trigan
              LTD. Trigan LTD is the data controller and can be contacted at:
            </p>
            ...
            <div className="my-2">
              ...
              <p>
                ...
                (the &#34;GDPR&#34;). For users in the United Kingdom, we adhere
                to the GDPR as enshrined in the Data Protection Act 2018.
              </p>
              <br />
              <p>
            ...
            <div className="my-2">
              ...
              <p>
                ...
                strict confidentiality agreements and a breach of this agreement
            ...
            <div className="my-2">
              ...
              <p>
                ...
                knowingly collect or use personal data from children under 16
                ...
                deleted as soon as possible. If a child under 16 years of age
                has provided us with personal data their parent or guardian may
            ...
            <div className="my-2">
              ...
              <p>
                ...
                if you would like your data to be deleted or modified in any
                way, or if you would like to exercise any of your other rights
                under the GDPR, please contact our privacy officer here:
              </p>
              <br />
              <p>Aaron Sarginson</p>
            ...
            <div className="my-2">
              ...
              <p>
                ...
                our Site over time and across third party websites and therefore
                do not respond to browser-initiated DNT signals.
              </p>
            </div>
            {/* do not track ends */}
            ...
            <div className="my-2">
              ...
              <p>
                ...
                cookies entirely in your internet browser, but this may decrease
            ...
            <div className="my-2">
              ...
              <p>
                ...
                Privacy Policy. We recommend that our users periodically review
                our Privacy Policy to ensure that they are notified of any
                updates. If necessary, we may notify users by email of changes
            ...
            <div className="my-2">
              ...
              <p>
                ...
                the Contact Information section so that we can, where possible,
                resolve the issue. If you feel we have not addressed your
                concern in a satisfactory manner you may contact a supervisory
                authority. You also have the right to directly make a complaint
                to a supervisory authority. You can lodge a complaint with a
                supervisory authority by contacting the Information
