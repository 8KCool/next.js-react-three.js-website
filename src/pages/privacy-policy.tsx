        ...
        <div className="mx-auto mt-5 max-w-4xl">
          ...
          <div className="my-2">
            ...
            <p>
              ...
              &#34;GDPR&#34;). For users in the United Kingdom, we adhere to the
          ...
          <div className="my-2">
            ...
            <p>
              In order to protect your security, we implement SSL certification
              across all of our sites and servers. All of our data are stored on
              servers in secure facilities. All data are only accessible to our
          ...
          <div className="my-2">
            ...
            <p>
              ...
              Privacy Policy to ensure that they are notified of any updates. If
              necessary, we may notify users by email of changes to this Privacy
              Policy.
            </p>
          </div>
          {/* modification ends */}
          ...
          <div className="my-2">
            ...
            <p>
              ...
              resolve the issue. If you feel we have not addressed your concern
              in a satisfactory manner you may contact a supervisory authority.
              You also have the right to directly make a complaint to a
              supervisory authority. You can lodge a complaint with a
          ...
          <div className="my-2">
            ...
            <p>
              ...
              our privacy officer, Aaron Sarginson, at:
            </p>
            <br />
            <p>aaron@thesmartest.city</p>
            <p>+44 7745 669953</p>
