            ...
            <div className="sm:px-4 md:px-8 sm:px-8 md:px-20 lg:px-32">
                ...
                <div className='mt-32 mb-6 sm:px-2'>
                    ...
                    <div className='flex flex-col md:flex-row md:mt-5'>
                        <div className='w-full text-justify md:text-left'>
                            <div className='px-4'>
                        ...
                        <div className="py-6 px-2 rounded-3xl shadow-md bg-white-800">
                            <div className='flex flex-row'>
                                <div className='w-full p-4 text-right'>
                                    ...
                                    <h5 className="my-2 text-2xl md:text-4xl font-medium tracking-tight text-white">Empowering</h5>
                                    <h5 className="mb-2 text-2xl md:text-4xl font-medium tracking-tight text-violet-600">Communities and Individuals</h5>
                        ...
                        <div className="py-6 px-2 rounded-3xl shadow-md bg-white-800">
                            <div className='flex flex-row'>
                                <div className='w-full p-4'>
                                    ...
                                    <h5 className="my-2 text-2xl md:text-4xl font-medium tracking-tight text-white">From <span className='text-violet-600'>Poverty to Inequality</span></h5>
