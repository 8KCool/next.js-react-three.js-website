      ...
      <section className="text-justify">
        ...
        <div className="mx-auto max-w-4xl py-5">
          <p className="py-2">
            ...
            owned and operated by Trigan LTD. This Site is an ecommerce website.
          </p>
          <p className="py-5">
          ...
          <div className="py-2">
            ...
            <p>
              ...
              property of Trigan LTD and the Site&#39;s creators. This includes,
          ...
          <div className="py-2">
            ...
            <p className="py-2">
              ...
              not legally bound by such information, descriptions, or images as
              we cannot guarantee the accuracy of all goods and services we
              provide. You agree to purchase goods and services from our Site at
              your own risk.
            </p>
            <p className="py-2">
          ...
          <div className="py-2">
            ...
            <p>
              If you are a customer living in the United Kingdom or the European
              Union you have the right to cancel your contract to purchase goods
              and services from us within 14 days without giving notice. The
              cancellation period:
            </p>
            ...
            <p className="py-2">
              ...
              contact us by email at contact@trigan.org or by post at 9 Watling
              Street, Dumfries, Dumfries and Galloway, DG1 1HF. You may use a
              copy of the Cancellation Form, found at the end of these Terms and
            ...
            {RIGHT_TO_CANCEL_DOES_NOT_APPLY_OPTIONS.map((option, i) => {
              return <TermPoint key={option} content={`${i + 1}. ${option}`} />
            })}
          </div>
          ...
          <div className="py-2">
            ...
            <p className="py-2">
              ...
              during the cancellation period and acknowledge that your right to
              cancel the contract is lost by the supply of digital content
              during the cancellation period, you will no longer have a right to
              cancel the contract.
            </p>
            <p className="py-2">
          ...
          <div className="py-2">
            ...
            <p>
              ...
              and hold harmless Trigan LTD and our directors, officers, agents,
          ...
          <div className="py-5">
            ...
            <div className="py-4">
              <p>To: trigan.org</p>
              <p>
                Address: 9 Watling Street, Dumfries, Dumfries and Galloway, DG1
                1HF
              </p>
