...
const TermsAndConditions: React.FC<TermsAndConditionsProps> = () => {
  return (
    <>
      <SEO title="Terms & Conditions" description="Trigan Terms & Conditions" />
      <GlobalLayout>
        <section className="text-justify">
          ...
          <div className="mx-auto max-w-4xl py-5">
            ...
            <div className="py-2">
              ...
              <p className="py-2">
                By posting publicly on our Site, you agree not to act illegally
            ...
            <div className="py-2">
              ...
              <p className="py-2">
                ...
                goods and services are as accurate as possible. However, we are
                not legally bound by such information, descriptions, or images
                as we cannot guarantee the accuracy of all goods and services we
                provide. You agree to purchase goods and services from our Site
                at your own risk.
              </p>
              <p className="py-2">
                We reserve the right to modify, reject or cancel your order
                whenever it becomes necessary. If we cancel your order and have
                already processed your payment, we will give you a refund equal
                to the amount you paid. You agree that it is your responsibility
                to monitor your payment instrument to verify receipt of any
                refund.
              </p>
            </div>
            ...
            <div className="py-2">
              ...
              <p>
                ...
                assume any responsibility for the goods and services users sell
                on our Site. We cannot guarantee the quality or accuracy of any
                goods and services sold by users on our Site. However, if we are
                made aware that a user is violating these Terms and Conditions,
                we reserve the right to suspend or prohibit the user from
          ...
          <TermPoint
              ...
              <p className="py-2">
                ...
                authorise us to charge the amount due to this payment
                instrument.
              </p>
              <p className="py-2">
            ...
            <div className="py-2">
              ...
              <p>
                ...
                cancellation period, you are required to pay us an amount which
                is in proportion to what has been performed until you have
                communicated to us your decision to cancel this contract. We
                will reimburse to you any amount you have paid above this
                proportionate payment.
              </p>
              <p className="py-2">
                If you provide express consent to the supply of digital content
                during the cancellation period and acknowledge that your right
                to cancel the contract is lost by the supply of digital content
                during the cancellation period, you will no longer have a right
                to cancel the contract.
              </p>
              <p className="py-2">
                We will make the reimbursement using the same form of payment as
                you used for the initial purchase unless you have expressly
            ...
            <div className="py-2">
              ...
              <p>
                ...
                and hold harmless Trigan LTD and our directors, officers,
                agents, employees, subsidiaries, and affiliates from any
            ...
            <div className="py-2">
              ...
              <p>
                ...
                be removed from these Terms and Conditions. All other provisions
                will not be affected by the removal and the rest of these Terms
            ...
            <div className="py-5">
              ...
              <p className="py-2">
                If you want to cancel your contract of sale with us you may use
                this form and email or post it back to us at the address below.
              </p>
              <div className="py-4">
                <p>To: trigan.org</p>
                <p>
