        ...
        <div className="relative w-screen">
            <div className="px-8 md:px-24 lg:px-32">
                <div className='grid justify-items-center'>
                    ...
                    <div className='mt-5'>
                        <p className='text-6xl font-medium text-white font-sans'>A New Kind of Investment <span className='text-violet-600'>Opportunity</span></p>
                    </div>
                    <div className='mt-3 px-4'>
                        <p className='text-slate-400 leading-relaxed text-center text-lg font-sans'>
                    ...
                    <div className='mt-5'>
                    <button role="button"
                            className="bg-red-600 hover:bg-red-700 lg:px-4 md:px-2 lg:py-2 md:py-1 lg:text-md md:text-sm md:ml-2 font-bold text-white border rounded-full">
                    Start Explore Now
                    </button>
                    </div>
                </div>
                ...
                <div className='mt-32 mb-6'>
                    ...
                    <div className='mt-5'>
                        <p className='text-6xl font-medium text-white font-sans'>Combining <span className='text-violet-600'>Web3 and Web2</span></p>
                    </div>
                    <div className='flex flex-row mt-5'>
                        ...
                        <div className='w-7/12'>
                            <div className='flex flex-row items-start px-8'>
                                <div>
                                    <svg className="w-10 h-10 text-white-500 mt-3" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 5a3 3 0 015-2.236A3 3 0 0114.83 6H16a2 2 0 110 4h-5V9a1 1 0 10-2 0v1H4a2 2 0 110-4h1.17C5.06 5.687 5 5.35 5 5zm4 1V5a1 1 0 10-1 1h1zm3 0a1 1 0 10-1-1v1h1z" clip-rule="evenodd"></path><path d="M9 11H3v5a2 2 0 002 2h4v-7zM11 18h4a2 2 0 002-2v-5h-6v7z"></path></svg>
                                </div>
                                <div className='ml-3'>
                ...
                <div className='grid justify-items-center mt-16'>
                    ...
                    <div className='mt-5'>
                        <p className='text-6xl font-medium text-white font-sans'>Benifit Will  <span className='text-violet-600'>You Get</span></p>
                    </div>
                    <div className="grid grid-cols-3 gap-4 mt-10">
                        <div className="max-w-sm p-6 bg-zinc-800 bg-opacity-80 border border-gray-400 rounded-xl shadow-md bg-white-800">
                            <svg className="w-10 h-10 mb-2 text-white-500" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 5a3 3 0 015-2.236A3 3 0 0114.83 6H16a2 2 0 110 4h-5V9a1 1 0 10-2 0v1H4a2 2 0 110-4h1.17C5.06 5.687 5 5.35 5 5zm4 1V5a1 1 0 10-1 1h1zm3 0a1 1 0 10-1-1v1h1z" clip-rule="evenodd"></path><path d="M9 11H3v5a2 2 0 002 2h4v-7zM11 18h4a2 2 0 002-2v-5h-6v7z"></path></svg>
                            <h5 className="mb-2 text-2xl font-medium tracking-tight text-white mt-3">High Potential</h5>
                            <p className="mb-3 font-normal text-gray-500 text-gray-400 text-sm leading-relaxed">
                        ...
                        <div className="max-w-sm p-6 bg-zinc-800 bg-opacity-80 border border-gray-400 rounded-xl shadow-md bg-white-800">
                            <svg className="w-10 h-10 mb-2 text-white-500" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 5a3 3 0 015-2.236A3 3 0 0114.83 6H16a2 2 0 110 4h-5V9a1 1 0 10-2 0v1H4a2 2 0 110-4h1.17C5.06 5.687 5 5.35 5 5zm4 1V5a1 1 0 10-1 1h1zm3 0a1 1 0 10-1-1v1h1z" clip-rule="evenodd"></path><path d="M9 11H3v5a2 2 0 002 2h4v-7zM11 18h4a2 2 0 002-2v-5h-6v7z"></path></svg>
                            <h5 className="mb-2 text-2xl font-medium tracking-tight text-white mt-3">Unique Position</h5>
                            <p className="mb-3 font-normal text-gray-500 text-gray-400 text-sm leading-relaxed">
                        ...
                        <div className="max-w-sm p-6 bg-zinc-800 bg-opacity-80 border border-gray-400 rounded-xl shadow-md bg-white-800">
                            <svg className="w-10 h-10 mb-2 text-white-500" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 5a3 3 0 015-2.236A3 3 0 0114.83 6H16a2 2 0 110 4h-5V9a1 1 0 10-2 0v1H4a2 2 0 110-4h1.17C5.06 5.687 5 5.35 5 5zm4 1V5a1 1 0 10-1 1h1zm3 0a1 1 0 10-1-1v1h1z" clip-rule="evenodd"></path><path d="M9 11H3v5a2 2 0 002 2h4v-7zM11 18h4a2 2 0 002-2v-5h-6v7z"></path></svg>
                            <h5 className="mb-2 text-2xl font-medium tracking-tight text-white mt-3">Strong Partnerships</h5>
                            <p className="mb-3 font-normal text-gray-500 text-gray-400 text-sm leading-relaxed">
                                The potential for growth and return on Investment is one of the main reasons to consider Trigan as part of your portfolio. 
                            </p>
                            <a href="#" className="inline-flex items-center text-violet-600 mt-3">
                    ...
                    <div className="mt-10 w-full px-12">
                        <div className="py-12 px-28 bg-zinc-800 bg-opacity-80 rounded-3xl shadow-md bg-white-800">
                            <div className='flex flex-row'>
                                <div className='w-8/12 p-4'>
                                    <p className="mb-2 text-base font-extralight text-white">Let's Join us</p>
                                    <h5 className="mb-2 text-2xl font-medium tracking-tight text-white">Contact Our Team</h5>
                                    <p className="mb-3 font-normal text-gray-500 text-gray-400 text-sm leading-relaxed">
                                        The potential for growth and return on Investment is one of the main reasons to consider Trigan as part of your portfolio. 
                                    </p>
                                </div>
                                <div className='flex flex-row w-4/12 p-4 items-center'>
                                    <button role="button"
                                            className="bg-red-600 hover:bg-red-700 lg:px-4 md:px-2 lg:py-2 md:py-1 lg:text-md md:text-sm md:ml-6 font-bold text-white border rounded-full">
                                    Try Now
                                    </button>
                                    <button role="button"
                                            className="lg:px-4 md:px-2 lg:py-2 md:py-1 lg:text-md md:text-sm md:ml-6 font-bold text-white border rounded-full">
                                    Learn More
                                    </button>
                                </div>
                            </div>
