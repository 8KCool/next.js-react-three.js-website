              ...
              <div className="grid justify-items-center">
                ...
                <div className="mt-3 px-4">
                  <p className="text-justify font-sans leading-snug  text-slate-400 sm:text-sm md:text-center md:text-lg md:leading-relaxed">
                    Trigan's community funding mechanism and real-world relevant
              ...
              <div className="mt-32 mb-6 sm:px-2">
                ...
                <div className="flex flex-col md:mt-5 md:flex-row">
                  <div className="w-full text-justify md:w-8/12 md:text-left">
                    <div className="px-4 md:px-4">
                      <p className="my-8 text-sm font-normal leading-relaxed text-gray-400">
                        Trigan's community structure allows small businesses and
                        local organisations to tap into new markets and customer
                        bases. As part of a larger community, businesses and
                        organisations can gain access to a wider range of
              ...
              <div className="mt-32 mb-6 sm:px-2">
                ...
                <div className="flex flex-col md:mt-5 md:flex-row">
                  ...
                  <div className="w-full text-justify md:w-8/12 md:text-right">
                    <div className="px-4 md:px-8">
                      <p className="my-8 text-sm font-normal leading-relaxed text-gray-400">
                        Trigan's community funding mechanism and real-world
                        relevant smart contracts offer a glimpse into the future
                        of small business and local organisation growth and
                        security. By joining Trigan, you can be a part of this
                        exciting new era and take your business or organisation
                        to new heights.
                      </p>
